...
brandId = doc("select[id = 'ds']").find("option").eq(55).attr("value")
evalue = doc("select[id = 'ds']").find("option").eq(55).attr("evalue")
# print brandId
brandName = doc("select[id = 'ds']").find("option").eq(55).text()
...
for j in  range(length_dept):
	...
	for k in range(length_style):
		...
		maintain_per_flag_index_all = maintain.find("\n")
		# print maintain_per_flag_index_all
		maintain_per_flag_all = maintain[maintain_per_flag_index_all + 1: -1]
		# print maintain_per_flag_all
		maintain_per_flag_index1 = maintain_per_flag_all.find("：")
		maintain_per_flag_index2 = maintain_per_flag_all.find("/")
		maintain_per_flag = maintain_per_flag_all[maintain_per_flag_index1+1:maintain_per_flag_index2]
		print maintain_per_flag
		# maintain_per_period_index = maintain_per_flag_all.find(" ")
		maintain_per_period = maintain_per_flag_all[maintain_per_flag_index2+1:]
		print maintain_per_period
